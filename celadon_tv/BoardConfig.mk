...
ifeq ($(BASE_CHROMIUM_KERNEL), true)
  ...
  TARGET_BOARD_KERNEL_HEADERS := $(INTEL_PATH_COMMON)/kernel/lts2019-yocto/kernel-headers
else
  TARGET_BOARD_KERNEL_HEADERS := $(INTEL_PATH_COMMON)/kernel/lts2019-chromium/kernel-headers
endif
...
##############################################################
# Source: device/intel/mixins/groups/device-type/tv/BoardConfig.mk
##############################################################
DEVICE_PACKAGE_OVERLAYS += device/google/cuttlefish/shared/tv/overlay
##############################################################
# Source: device/intel/mixins/groups/device-specific/celadon_tv/BoardConfig.mk
##############################################################
